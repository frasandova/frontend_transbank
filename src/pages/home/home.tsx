...
export const Home = () => {
  ...
  const handlerFormClick  = async () => {
    console.log('click');
    console.log('document.forms[0]',document.forms)
    if (document.forms.namedItem("formActiosPostTransbank")) { // when form is present
  ...
  const makeGetRequest = async () => {
    ...
    .then(response => {
      ...
      const { data: { 
        viewData : {
          buyOrder, sessionId, amount, returnUrl, token, url
      }}} = response;
    //   "viewData": {
    //     "buyOrder": "O-80861",
    //     "sessionId": "S-24201",
    //     "amount": 1134,
    //     "returnUrl": "http://localhost:8081/webpay_plus/commit",
    //     "token": "01ab65fceaef76bb2433916792df611fa0af433903e126c473447db49bd24b63",
    ...
    <>
     ...
     <div className='row'>
      <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
          <div className="card"> 
            <img src="../assets/img1.jpeg" className="card-img-top" alt="..."/>
      ...
      <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
          <div className="card"> 
            <img src="../assets/img2.jpeg" className="card-img-top" alt="..."/>
            <div className="card-body">
              <h5 className="card-title">Card title</h5>
              <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
      ...
      <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
          <div className="card"> 
            <img src="../assets/img3.jpeg" className="card-img-top" alt="..."/>
            <div className="card-body">
              <h5 className="card-title">Card title</h5>
              <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              <a href='#' type='button'className='btn btn-primary' >
     ...
     <div className="row justify-content-center">
      <div className="col-lg-4 col-md-4 col-sm-4 col-xs-4">
          <div className="card"> 
            <img src="../assets/imgTransBank1.png" className="card-img-top" alt="..."/>
            <div className="card-body">
              <h5 className="card-title">Card title</h5>
              <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              <a href="#" className="btn btn-primary">Transbank</a>
            </div>
          </div>
      </div>
    </div>
